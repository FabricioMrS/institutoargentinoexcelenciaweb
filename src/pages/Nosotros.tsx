      ...
      <div className="flex-grow container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <Card className="overflow-hidden border-none shadow-lg bg-gradient-to-br from-blue-50 to-purple-50 dark:from-secondary/5 dark:to-blue-800/10 animate-fadeIn">
              <CardContent className="p-8 md:p-10">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="w-full md:w-1/3 flex justify-center">
                    <div className="w-40 h-40 rounded-full bg-white dark:bg-gray-800/40 shadow-lg flex items-center justify-center p-4 border-2 border-secondary">
                      <img 
            ...
            <Card className="overflow-hidden border-none shadow-lg bg-gradient-to-br from-green-50 to-blue-50 dark:from-secondary/10 dark:to-blue-800/10 animate-fadeIn">
              <CardContent className="p-8 md:p-10">
                <h2 className="text-2xl md:text-3xl font-semibold text-primary dark:text-secondary mb-6">
                  Nuestros Servicios
                </h2>
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-white dark:bg-gray-800/30 p-6 rounded-lg shadow-sm border border-secondary/20 hover:shadow-md transition-shadow">
                    <h3 className="text-xl font-medium text-primary dark:text-secondary/90 mb-3">Preparación Universitaria</h3>
                  ...
                  <div className="bg-white dark:bg-gray-800/30 p-6 rounded-lg shadow-sm border border-secondary/20 hover:shadow-md transition-shadow">
                    <h3 className="text-xl font-medium text-primary dark:text-secondary/90 mb-3">Formación Profesional</h3>
                    <p className="text-muted-foreground dark:text-gray-300">
            ...
            <Card className="overflow-hidden border-none shadow-lg bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-secondary/10 dark:to-secondary/5 animate-fadeIn">
              <CardContent className="p-8 md:p-10">
                <h2 className="text-2xl md:text-3xl font-semibold text-primary dark:text-secondary mb-6">
                  Nuestros Valores
                </h2>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {[
                    ...
                    <div key={index} className="flex flex-col items-center text-center p-4 bg-white dark:bg-gray-800/20 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-transparent dark:border-secondary/20">
                      <div className="w-16 h-16 bg-gradient-to-br from-primary/10 to-secondary/30 dark:from-secondary/30 dark:to-secondary/20 rounded-full flex items-center justify-center mb-4">
                        <span className="text-2xl text-primary dark:text-secondary font-bold">{index + 1}</span>
                      </div>
                      <h3 className="text-lg font-medium text-primary dark:text-secondary/90 mb-2">{value.title}</h3>
                      <p className="text-sm text-muted-foreground dark:text-gray-300">{value.description}</p>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            {/* Contact CTA section - updated with gold accents */}
            <Card className="overflow-hidden border-none shadow-lg bg-gradient-to-br from-purple-50 to-pink-50 dark:from-secondary/10 dark:to-blue-800/10 animate-fadeIn">

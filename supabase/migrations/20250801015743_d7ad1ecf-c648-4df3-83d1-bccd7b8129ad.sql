...
AS $function$
  SELECT crypt(password, gen_salt('bf'::text, 12));
$function$;
...
-- Update create_password_reset_token function with proper search_path
...
-- Update verify_reset_token function with proper search_path
...
-- Update reset_password_with_token function with proper search_path

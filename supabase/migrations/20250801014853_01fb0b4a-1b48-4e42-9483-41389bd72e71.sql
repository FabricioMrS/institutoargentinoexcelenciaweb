-- Security Fix Migration: Critical RLS and Authentication Improvements (Fixed)
...
-- Fix password hashing function to use proper bcrypt with explicit type casting
